...
const UpdateProduct = () => {
    ...
    const { model, brand, image, price, keyFeature, status } = useSelector(state => state.product.singleProduct)
    const { updateId } = useParams()


    useEffect(() => {
        dispatch(fetchSingleProduct(updateId))
    }, [updateId, dispatch])
        ...
        <div className='flex justify-center items-center h-full '>
            ...
            >
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <select name='brand' id='brand' defaultValue="test" {...register("brand")}>
